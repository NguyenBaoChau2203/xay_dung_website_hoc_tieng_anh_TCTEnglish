...
namespace TCTEnglish.Migrations
{
    ...
    [Migration("20260509145534_AddReadingUserTranslation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TCTEnglish.Models.ReadingTranslationVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReadingTranslationVotes", (string)null);
                });

            modelBuilder.Entity("TCTEnglish.Models.ReadingUserTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReadingPassageId", "UserId")
                        .HasDatabaseName("IX_ReadingUserTranslations_PassageId_UserId");

                    b.ToTable("ReadingUserTranslations", (string)null);
                });
            ...
            modelBuilder.Entity("TCTEnglish.Models.ReadingTranslationVote", b =>
                {
                    b.HasOne("TCTEnglish.Models.ReadingUserTranslation", "Translation")
                        .WithMany("Votes")
            ...
            modelBuilder.Entity("TCTEnglish.Models.ReadingUserTranslation", b =>
                {
                    ...
                    b.HasOne("TCTVocabulary.Models.User", "User")
                        .WithMany("ReadingUserTranslations")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("TCTVocabulary.Models.User", b =>
                {
                    ...
                    b.Navigation("ReadingUserTranslations");
